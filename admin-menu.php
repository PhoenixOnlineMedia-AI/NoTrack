 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_admin_menu')) {
 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_settings_page')) {
 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_detected_tools_page')) {
 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_external_scanner_page')) {
 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_help_page')) {
 ...
 * @since 1.0.0
 */
if (!function_exists('notrack_ajax_scan_callback')) {
